...
export default defineConfig({
	...
	integrations: [
		starlight({
			title: '🥷 TryHackMe',
			social: [
				{ icon: 'github', label: 'GitHub', href: 'https://github.com/seclabs-cc/TryHackMe' },
			],
			sidebar: [
  {
    "label": "🥷 TryHackMe",
  ...
  {
    "label": "Web Hacking Fundamentals",
    "items": [
      {
        "label": "OWASP Top10",
        "items": [
