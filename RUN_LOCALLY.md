# 💻 Running TryHackMe Walkthroughs Locally
...
👉 **[http://localhost:4321/TryHackMe/](http://localhost:4321/TryHackMe/)**
...
| Command | Description |
| :--- | :--- |
| `npm run dev` | Starts the local dev server at `http://localhost:4321/TryHackMe/` |
